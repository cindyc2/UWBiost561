...
!Need to do stopped here to write tests
...
This homework was incredibly difficult, conceptually and logistically. I have not written more than a handful of basic functions. So every single line of these functions forced me to google how to label your commands. I have no idea how to create the function this complex. 

I also had to brush up on my combinatorix and spend time understanding how the graph is represented by the matrix because that is not intuitive or something we worked on previously in the program or in the required prereqs.  

Instead of having other students judge and test this function that I couldn't get to run, I would have much preferred to have the written a draft myself, and then formed teams during the next class to learn how to actually make our ideas run. 
I think I have a cool idea but no experience implementing it. 
All of the students I talked to had a horrible time with ChatGPT. Some went dozens of rounds with error messages because we have no other ideas.


#Final Note: use rmarkdown::render("vignettes/HW3.Rmd") in console (not in Rmd)
